...
import pearlDown from "@/assets/pearl_down.png";
import pearlUp from "@/assets/pearl_up.png"
  ...
  return (
    <div className='w-screen h-20 fixed top-0 left-0 flex max-md:flex-col-reverse max-md:gap-4 max-md:mt-10 items-center justify-center p-4 z-[100]'>
        <div className='md:w-[60%] flex items-center gap-2'>
            <a href='https://build-a-pearl.tacotribe.shop/' target='_blank' className='group w-10'><Image src={pearlUp} alt='webUp' className='group-hover:hidden' /><Image src={pearlDown} alt='webDown' className='hidden group-hover:flex' /></a>
